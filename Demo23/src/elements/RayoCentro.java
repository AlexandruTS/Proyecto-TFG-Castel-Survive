...
public class RayoCentro extends Element {
	...
	public RayoCentro(float x, float y, Stage s, GameScreen nivel, boolean balaPlayer) {
		super(x, y, s);
		this.nivel = nivel;
		animacion = this.loadFullAnimation("player/Rayo_Arriba.png", 1, 1, 1, false);
		this.setRectangle();
