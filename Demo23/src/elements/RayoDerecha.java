...
public class RayoDerecha extends Element {
	...
	public RayoDerecha(float x, float y, Stage s, GameScreen nivel, boolean balaPlayer) {
		super(x, y, s);
		this.nivel = nivel;
		animacion = this.loadFullAnimation("player/Rayo_Derecha.png", 1, 1, 1, false);
		this.setRectangle();
