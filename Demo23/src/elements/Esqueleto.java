...
public class Esqueleto extends Enemy {
    ...
    public Esqueleto(float x, float y, Stage s, GameScreen nivel) {
        super(x, y, s, nivel);
        walkDerecha = loadFullAnimation("enemies/esqueleto/esqueletoDerecha.png", 2, 1, 0.15f, true);
        walkIzquierda = loadFullAnimation("enemies/esqueleto/esqueletoIzquierda.png", 2, 1, 0.15f, true);
